...
/**
 * Title: Простой слайдер для отзывов
 * Slug: gutpurple/slider-feedback
 * Categories: text, layout
 * Description: Простой слайдер - 1 слайд
 */
?>
...
<div class="wp-block-group alignfull slider-section">
    ...
    <div class="wp-block-group container">
        ...
        <!-- wp:columns {"className":"slider-feedback swiper"} -->
        <div class="wp-block-columns slider-feedback swiper">
            <!-- wp:column {"className":"swiper-wrapper"} -->
            <div class="wp-block-column swiper-wrapper">

                <!-- wp:group {"className":"slider-feedback__slide swiper-slide"} -->
                <div class="wp-block-group slider-feedback__slide swiper-slide">

                    <!-- wp:image {"url":"https://via.placeholder.com/300x200","alt":"слайд","className":"simple-slider__slide__image swiper-slide"} -->
                    <figure class="wp-block-image slider-feedback__slide__image"><img src="<?php echo get_stylesheet_directory_uri() ?>/images/svg/placeholder.svg" alt="слайд" /></figure>
                    <!-- /wp:image -->

                    <!-- wp:paragraph -->
                    <p>Это основной текст отзыва.</p>
                    <!-- /wp:paragraph -->
