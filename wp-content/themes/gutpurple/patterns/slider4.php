...
/**
 * Title: Простой слайдер с описаниями (4 слайда)
 * Slug: gutpurple/slider4
 * Categories: text, layout
 * Description: Простой слайдер - 3 слайда
 */
?>
...
<div class="wp-block-group alignfull slider-section">
    ...
    <div class="wp-block-group container">
        ...
        <!-- wp:columns {"className":"slider-four swiper"} -->
        <div class="wp-block-columns slider-four swiper">
            <!-- wp:column {"className":"swiper-wrapper"} -->
            <div class="wp-block-column swiper-wrapper">

                <!-- wp:group {"className":"simple-slider__slide swiper-slide"} -->
                <div class="wp-block-group simple-slider__slide swiper-slide">

                    <!-- wp:image {"url":"https://via.placeholder.com/300x200","alt":"слайд","className":"simple-slider__slide__image swiper-slide"} -->
                    <figure class="wp-block-image simple-slider__slide__image"><img src="<?php echo get_stylesheet_directory_uri() ?>/images/svg/placeholder.svg" alt="слайд" /></figure>
                    <!-- /wp:image -->

                    <!-- wp:group {"className":"wp-block-group simple-slider__slide__content"} -->
                    <div class="wp-block-group simple-slider__slide__content">
